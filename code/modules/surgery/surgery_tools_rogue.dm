...
/obj/item/weapon/surgery/cautery/baotha_brander
	name = "cauterizing iron"
...
/obj/item/weapon/surgery/cautery/baotha_brander/attack(mob/living/carbon/human/target, mob/living/user)
	if(!istype(target))
		return ..()

	if(!heated && get_temperature() < T0C + 400)
